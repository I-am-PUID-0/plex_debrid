                ...
                if choice == "1":
                        ...
                        for prompt in self.prompt:
                            if "code" in prompt:
                                try:
                                    ...
                                    print(
                                        "It seems that this authentication service could not be reached. Please try again at a later time."
                                    )
                                    return
                    ...
                    if not self.radio:
                        ...
                        for index, entry in enumerate(lists):
                            if self.moveable:
                                print(
                                    str(index + 1) + ") Edit " + self.entry + " " + str(index + 1) + ": " + str(entry)
                                )
                            else:
                        ...
                        for prompt in self.prompt:
                            if "code" in prompt:
                                try:
                                    ...
                                    print(
                                        "it seems this authentication service could not be reached right now. Please try again later."
                                    )
                                    return
                                print(prompt + str(user_code))
                                edit += [self.cls.oauth(device_code)]
...
settings_list = [
    [
        ...
        [
            ...
            setting(
                "Plex users",
                ["Please provide a name for this Plex user: ", "Please provide the Plex token for this Plex user: "],
    ...
    [
        ...
        [
            ...
            setting(
                ...
                'Please enter the jackett indexer filters that should be used, separated by a "," character. Enter "all" to not filter your indexers: ',
                scraper.services.jackett,
                "filter",
                hidden=True,
            ),
            ...
            setting(
                ...
                ["Please enter a valid orionoid parameter: ", "Please enter a valid value: "],
                scraper.services.orionoid,
                "default_opts",
                entry="parameter",
            ...
            setting(
                "Torrentio Base URL",
                "Please specify your Torrentio base URL (eg. https://torrentio.strem.fun/): ",
                scraper.services.torrentio,
                "base_url",
                hidden=True,
            ),
            setting(
                "Zilean Base URL",
                "Please specify your Zilean base URL: ",
                scraper.services.zilean,
                "base_url",
                hidden=True,
            ),
            setting(
                "Mediafusion Base URL",
                "Please specify your Mediafusion base URL: ",
                scraper.services.mediafusion,
                "base_url",
                hidden=True,
            ),
            setting(
                "Mediafusion API Key",
                "Please specify your Mediafusion API Key: ",
                scraper.services.mediafusion,
                "api_password",
                hidden=True,
            ),
            setting(
                "Mediafusion Request Timeout",
                "Please enter the request timeout in seconds: ",
                scraper.services.mediafusion,
                "request_timeout_sec",
                hidden=True,
            ),
            setting(
                "Mediafusion Rate Limit",
                "Please enter the minimum number of seconds between requests: ",
                scraper.services.mediafusion,
                "rate_limit_sec",
                hidden=True,
            ),
            setting(
                "Mediafusion Scraper Parameters",
                "Please enter a valid Mediafusion manifest URL: ",
                scraper.services.mediafusion,
                "manifest_json_url",
                entry="parameter",
            ...
            setting(
                "Comet Scraper Parameters",
                "Please enter a valid Comet manifest URL: ",
                scraper.services.comet,
                "manifest_json_url",
                entry="parameter",
                help='This setting lets you control the comet scraping parameters. Visit "https://comet.elfhosted.com/configure" and configure your settings. Click on "Copy Link" and paste it here.',
                hidden=True,
            ),
        ],
    ],
    [
        ...
        [
            ...
            setting(
                "Torbox API Key", "Please enter your Torbox API Key: ", debrid.services.torbox, "api_key", hidden=True
            ),
        ],
    ],
    [
        ...
        [
            ...
            setting(
                "Watchlist loop interval (sec)",
                "Please enter an integer value in seconds: ",
                ui_settings,
                "loop_interval_seconds",
            ),
            setting(
                "version",
                "No snooping around! :D This is for compatibility reasons.",
                ui_settings,
                "version",
                hidden=True,
            ),
